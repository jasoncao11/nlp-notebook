...
def collate_fn(batch_data):
    ...
    Returns:
    """
    input_ids_list_1, attention_mask_list_1, len_list_1, input_ids_list_2, attention_mask_list_2, len_list_2, labels_list = [], [], [], [], [], [], []
    for instance in batch_data:
        # 按照batch中的最大数据长度,对数据进行padding填充
        input_ids_temp_1 = instance["input_ids_1"]
        attention_mask_temp_1 = instance["mask_1"]
        len_list_temp_1 = instance["len_1"]
        input_ids_temp_2 = instance["input_ids_2"]
        attention_mask_temp_2 = instance["mask_2"]
        len_list_temp_2 = instance["len_2"]
        ...
        len_list_1.append(len_list_temp_1)
        ...
        len_list_2.append(len_list_temp_2)
    ...
    return {"input_ids_1": pad_sequence(input_ids_list_1, batch_first=True, padding_value=0),
            ...
            "len_1":torch.tensor(len_list_1, dtype=torch.long),
            ...
            "len_2":torch.tensor(len_list_2, dtype=torch.long),
    ...
    def __init__(self, data_path, tokenizer_path, max_len):
        ...
        with open (data_path, 'r', encoding='utf8') as rf:
            ...
            for row in r:
                ...
                self.data_set.append({"input_ids_1": input_ids_1, "mask_1": mask_1, "len_1": len(input_ids_1), 
                                      "input_ids_2": input_ids_2, "mask_2": mask_2, "len_2": len(input_ids_2), 
                                      "label": label})
