...
from model import Sentence_Bert
...
model = Sentence_Bert.from_pretrained(BERT_PATH)
model.to(device)
...
for epoch in range(EPOCHS):
    ...
    for batch in pbar:
        ...
        model.zero_grad()
        out = model(input_ids_1, attention_mask_1, input_ids_2, attention_mask_2, METHOD)
